...
- Fix offline-render review findings: HUD capture, determinism, abort paths
- Add offline music-video rendering (--input song.mp3 --out video.mp4)
- Relicense to MIT OR Apache-2.0, bump to 0.3.0
